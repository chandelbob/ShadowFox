...
t_ayush_exp = sum(ayush.values())
print(f"The total expense of Mikasa is {t_ayush_exp}")

#------------------------------------------------------------------------------------------------------------------#

# Determine who spent more money overall and print the result.

if t_nitin_exp > t_ayush_exp :
    print("Nitin has spent more than Mikasa" )
elif t_nitin_exp < t_ayush_exp :
    print("ayush has spent more than Nitin")
else :
...
for catogory in Nitin :
    if Nitin != ayush :
        difference = (Nitin[catogory] - ayush[catogory])
